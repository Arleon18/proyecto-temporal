function eventListeners(){document.querySelector(".barras").addEventListener("click",navegacionResponsive)}function darkMode(){document.querySelector(".dark-mode-boton").addEventListener("click",(function(){document.body.classList.toggle("dark-mode")}));const e=window.matchMedia("(prefers-color-scheme: dark)");console.log(e.matches),e.matches?document.body.classList.add("dark-mode"):document.body.classList.remove("dark-mode"),e.addEventListener("change",(function(){e.matches?document.body.classList.add("dark-mode"):document.body.classList.remove("dark-mode")}))}function navegacionResponsive(){const e=document.querySelector(".navegacion"),n=document.querySelector(".header"),o=document.querySelector(".header__subtitulos");e.classList.toggle("nav-activa"),n.classList.toggle("nav-activa"),o.classList.toggle("nav-activa")}
